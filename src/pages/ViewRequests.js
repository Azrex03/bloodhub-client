...
export default function ViewRequests() {
  ...
  useEffect(() => {
    ...
    axios.get("https://bloodhub3.herokuapp.com/checkIfLoggedIn").then((response) => {
  ...
  const requestFormSubmit = () => {
    ...
    axios
      .post("https://bloodhub3.herokuapp.com/ViewRequests", manhoos)
      .then((response) => {
  ...
  const AccceptRequest = (e) => {
    ...
    axios
      .post("https://bloodhub3.herokuapp.com/AcceptRequest", details)
      .then((response) => {
        alert(response.data);
        requestFormSubmit();
      });
  ...
  const RejectRequest = (e) => {
    ...
    axios
      .post("https://bloodhub3.herokuapp.com/RejectRequest", details)
      .then((response) => {
        alert(response.data);
        requestFormSubmit();
      });

...
export default function RequestBlood() {
  ...
  const requestFormSubmit = () => {
    ...
    set_age_err("");
    axios
      .post("https://bloodhub3.herokuapp.com/requestBloodList", {
        city: city,
        b_group: b_group,
        l_age: l_age,
        u_age: u_age,
  ...
  const broadcast_message_submit = () => {
    ...
    set_empty_message("");
    axios
      .post("https://bloodhub3.herokuapp.com/postBroadcast", {
        u_cnic: user_cnic,
  ...
  const requestBloodFromUser = (e) => {
    ...
    axios
      .post("https://bloodhub3.herokuapp.com/postRequest", details)
      .then((response) => {

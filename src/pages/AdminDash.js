...
export default function AdminDash() {
  ...
  useEffect(() => {
    ...
    axios.get("https://bloodhub3.herokuapp.com/checkIfAdminLoggedIn").then((response) => {
  ...
  const fetchNotAprroved = () => {
    axios.get("https://bloodhub3.herokuapp.com/getNotAprrovedList").then((response) => {
  ...
  const approveUserFunc = (e) => {
    ...
    axios
      .post("https://bloodhub3.herokuapp.com/approveUser", details)
      .then((response) => {
        fetchNotAprroved();
      });
  };
  ...
  const searchFormSubmit = (e) => {
    ...
    console.log(b_group);
    axios
      .post("https://bloodhub3.herokuapp.com/viewAdminDonationHistory", {
        city: city,
        b_group: b_group,
      })
      .then((response) => {
                  ...
                  <li>
                    <a
                      ...
                      onClick={() => {
                        // console.log("clicked")
                        axios
                          .get("https://bloodhub3.herokuapp.com/logout")
                          .then((response) => {
